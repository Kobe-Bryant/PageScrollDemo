...
- (void)addShadow {
    ...
    [path addLineToPoint:CGPointMake(-1,self.view.layer.bounds.size.height+44.0)];
    line.path = path.CGPath;
    line.fillColor = nil;
    line.opacity = 1;
    line.lineWidth = 2.5;
    line.strokeColor = RGB(155,165,167,0.16).CGColor;
    [_rootViewController.view.layer addSublayer:line];
}
